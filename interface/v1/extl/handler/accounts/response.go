...
type TokenResponse struct {
	...
	AccessTokenExpired  time.Time `json:"access_token_exp" example:"2023-01-01T00:00:00Z"`
	...
	RefreshTokenExpired time.Time `json:"refresh_token_exp" example:"2023-01-01T00:00:00Z"`
}
